...
export class AuthService {
  ...
  signUp(profile: Profile) {
      return new Promise((resolve, reject) => {
        ...
        this.httpClient.post('https://shareplace-evo-backend.herokuapp.com/api/auth/signup', profile).subscribe(
  ...
  loginUser(userName: string, password: string) {
      return new Promise((resolve, reject) => {
        this.httpClient.post('https://shareplace-evo-backend.herokuapp.com/api/auth/login', {userName: userName, userPassword: password}).subscribe(
    ...
    getModeratorNews() {
      return new Promise((resolve, reject) => {
        this.httpClient.post('https://shareplace-evo-backend.herokuapp.com/api/moderate/news', {
    ...
    modifyPassword(password: string, userName: string) {
      return new Promise((resolve, reject) => {
        this.httpClient.put('https://shareplace-evo-backend.herokuapp.com/api/auth/changeP', {
          password: password,
          userName: userName          
      }).subscribe(
          (response :{message: string }) => {
    ...
    modifyUserName(newUserName: string) {
      return new Promise((resolve, reject) => {
        ...
        this.httpClient.put('https://shareplace-evo-backend.herokuapp.com/api/auth/changeU', {
    ...
    deleteAccount(userName: string) {
      return new Promise((resolve, reject) => {
        this.httpClient.post('https://shareplace-evo-backend.herokuapp.com/api/auth/deleteU', {userName: userName }).subscribe(
          (response :{message: string }) => {
            resolve(response);
          },
          (error) => {
    ...
    logout(userName: string, dateLogout: string) {
      return new Promise((resolve, reject) => {
        this.httpClient.put('https://shareplace-evo-backend.herokuapp.com/api/auth/logout', {userName: userName, dateLogout: dateLogout }).subscribe(
          (response :{message: string }) => {
            resolve(response);
            this.authToken = null;      
