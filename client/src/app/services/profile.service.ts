...
export class ProfileService {
    ...
    getProfileByUserName(userName: string) {
        return new Promise((resolve, reject) => {
          this.httpClient
          .get('https://shareplace-evo-backend.herokuapp.com/api/profiles/' + userName)
            .subscribe(
              (response) => {
    ...
    getNews(userName: string) {
      return new Promise((resolve, reject) => {
      this.httpClient
            .get('https://shareplace-evo-backend.herokuapp.com/api/profiles/notifications/' + userName)
            .subscribe(
              (response) => {
                const resp = Object.values(response);
  ...
  getUsersList() {
    return new Promise((resolve, reject) => {
        this.httpClient
          .get('https://shareplace-evo-backend.herokuapp.com/api/auth/list')
          .subscribe(
            (response) => {
  ...
  modifyProfile(profile: Profile) {
      return new Promise((resolve, reject) => {
        ...
        this.httpClient.put('https://shareplace-evo-backend.herokuapp.com/api/profiles/modify', profile).subscribe(
  ...
  loadPicture(userName: string, image: File) {
      return new Promise((resolve, reject) => {
        ...
        this.httpClient.post('https://shareplace-evo-backend.herokuapp.com/api/profiles/picture', formData).subscribe(
    (response :{message: string }
      ) => {
      resolve(response.message);
    },
  ...
  deletePicture(userName: string) {
    return new Promise((resolve, reject) => {
      this.httpClient.put('https://shareplace-evo-backend.herokuapp.com/api/profiles/picture/delete', {userName: userName}).subscribe(
  (response :{message: string }
    ) => {
    resolve(response.message);
  },
